...
@section('content')
    <ul class="nav nav-tabs" id="filter-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link {{ request('status') === 'in-process' ? 'active' : '' }}"
                href="{{ url()->current() }}?status=in-process" id="diproses-tab" role="tab">
                Diproses
            </a>
        </li>
        <li class="nav-item" role="presentation">
                        ...
                        <a href="{{ route('report.show', $report->code) }}" class="text-decoration-none text-dark">
                            <div class="card-body p-0">
                                <div class="card-report-image position-relative mb-2">
                                    ...
                                    @if ($report->reportStatuses->last()->status === 'in-process')
                                        <div class="badge-status on-process">
                                            Diproses
                                        </div>
                                    @endif
